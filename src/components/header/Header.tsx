...
export default function Header({ onSubscribeClick }: HeaderProps) {
  ...
  return (
    <header className="sticky top-0 z-40 bg-[#F7F7F8] w-full max-w-full min-w-0">
      <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 sm:h-20 flex items-center justify-between">
        ...
        <div className="hidden lg:flex items-center gap-6">
          ...
          <button
            ...
            className="w-[119px] h-[30px] rounded-[6px] border-2 border-sortd-yellow bg-transparent hover:bg-sortd-yellow/5 text-sortd-yellow font-body font-semibold text-[12px] tracking-normal transition-all duration-200 flex items-center justify-center px-[10px] gap-[10px] flex-shrink-0"
          >
