        ...
        >
            ...
            <nav className="flex flex-col gap-2">
              {navItems.map((item) => (
                <Link
                  ...
                  href={item.href}
                  onClick={onClose}
                  className="flex items-center justify-between px-4 py-3 rounded-xl font-body font-bold text-lg text-sortd-black hover:bg-sortd-off-white transition-all tracking-wider"
                >
          ...
          <div className="pt-6 border-t border-gray-100">
            <button
              ...
              className="w-full flex items-center justify-center gap-2 py-3.5 px-4 rounded-full bg-sortd-yellow text-sortd-black font-body font-bold text-sm tracking-wider uppercase shadow-sortd-sm hover:bg-sortd-yellow-hover transition-all"
            >
