...
export function MuseumOfTheFutureArt({ className = "w-full h-full" }: { className?: string }) {
  return (
    <svg viewBox="0 0 300 200" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
      ...
      <ellipse cx="150" cy="110" rx="100" ry="60" fill="#FFD100" opacity="0.35" />
      ...
      <path d="M 100 80 Q 150 65 200 85" stroke="#1B2F6E" strokeWidth="2.5" />
      ...
      <circle cx="150" cy="100" r="6" fill="#FFD100" stroke="#111111" strokeWidth="2" />
    </svg>
  );
}
...
export function DubaiFrameArt({ className = "w-full h-full" }: { className?: string }) {
  return (
    <svg viewBox="0 0 300 200" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
      {/* Background yellow subtle aura */}
      <rect x="80" y="30" width="140" height="130" fill="#FFD100" opacity="0.3" rx="10" />
      ...
      <line x1="105" y1="50" x2="195" y2="50" stroke="#E8185A" strokeWidth="3" />
...
export function BurjKhalifaSkylineArt({ className = "w-full h-full" }: { className?: string }) {
  return (
    <svg viewBox="0 0 400 200" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
      ...
      <circle cx="200" cy="90" r="70" fill="#FFD100" opacity="0.4" />
      ...
      {/* Left Tower */}
      <rect x="130" y="80" width="35" height="100" fill="#1B2F6E" opacity="0.9" />
      <polygon points="130,80 147,60 165,80" fill="#1B2F6E" />
      
      {/* Far Left Tower */}
      <rect x="80" y="110" width="30" height="70" fill="#111111" opacity="0.8" />
      
      {/* Right Tower */}
      <rect x="235" y="70" width="40" height="110" fill="#E8185A" opacity="0.8" />
      <polygon points="235,70 255,45 275,70" fill="#E8185A" />
