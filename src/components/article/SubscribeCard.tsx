            ...
            <form onSubmit={handleSubmit} className="w-full flex flex-col gap-3">
              <div className="relative">
                <input
                  ...
                  className="w-full px-4 py-3 rounded-[4px] border border-gray-200 text-xs font-medium text-sortd-black placeholder:text-gray-400 focus:outline-none focus:ring-1 focus:ring-sortd-black"
                />
                <Gift className="w-4 h-4 text-gray-400 absolute right-4 top-1/2 -translate-y-1/2" />
              </div>
              <button
                type="submit"
                className="w-full py-3 rounded-[4px] bg-sortd-yellow text-sortd-black font-body font-extrabold text-xs tracking-wider uppercase hover:bg-sortd-yellow-hover transition-colors shadow-sm text-center"
              >
                Subscribe
              </button>
            </form>
  ...
  return (
    <div className="w-full rounded-3xl bg-sortd-yellow border border-sortd-black/10 p-6 sm:p-8 text-sortd-black relative overflow-hidden shadow-sortd-md">
      <div className="max-w-xl mx-auto flex flex-col items-center text-center">
        ...
        {subscribed ? (
          <div className="flex items-center gap-2 px-6 py-3.5 rounded-full bg-sortd-black text-white font-body font-bold text-sm">
          ...
          <form onSubmit={handleSubmit} className="w-full max-w-md flex flex-col sm:flex-row gap-2.5">
            ...
            <button
              type="submit"
              className="px-6 py-3.5 rounded-full bg-sortd-black text-white font-body font-bold text-xs tracking-wider uppercase hover:bg-sortd-pink transition-colors shadow-md flex items-center justify-center gap-1.5 flex-shrink-0"
            >
              <span>SUBSCRIBE</span>
