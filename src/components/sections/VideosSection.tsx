            ...
            >
              <div className="relative max-w-6xl mx-auto px-4 py-8 sm:py-16 w-full flex-grow animate-fade-in">
                ...
                <button
                  ...
                  className="absolute top-4 right-4 p-2 rounded-[4px] bg-gray-200/60 hover:bg-gray-200 text-sortd-black transition-colors z-50 focus:outline-none"
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-16 items-start">
                  ...
                  <div className="lg:col-span-7 flex flex-col gap-6 w-full">
                    ...
                    <div className="flex items-center justify-between">
                      <span
                        className={`h-[22px] px-2.5 rounded-[4px] font-body font-bold text-[9px] uppercase tracking-wider inline-flex items-center justify-center gap-1 select-none ${badgeStyle.textColorClass}`}
                        style={{ backgroundColor: badgeStyle.bgColor }}
                      >
                        {icon}
                        <span>{activeVideo.category}</span>
                      </span>
                      <button className="flex items-center gap-2 border border-gray-200 bg-white hover:bg-gray-55 px-4 py-2 rounded-[4px] text-xs font-body font-bold text-gray-400 hover:text-black transition-colors uppercase tracking-wider">
                    ...
                    {/* Read Time Tag */}
                    <div className="inline-flex items-center gap-[6.09px] bg-sortd-yellow text-sortd-black h-[28.74px] py-[4.87px] px-[9.74px] rounded-[4px] font-body font-bold text-[9px] uppercase tracking-wider self-start shadow-sm select-none">
                    ...
                    {nextVideo && (
                      <div className="flex flex-col gap-2 mt-2">
                        <span className="inline-flex items-center justify-center bg-sortd-yellow text-sortd-black h-[28.74px] py-[4.87px] px-[9.74px] rounded-[4px] font-body font-bold text-[9px] uppercase tracking-wider self-start shadow-sm select-none">
                          UP NEXT
                        </span>
                        <div
                      ...
                      <form onSubmit={handleSubscribe} className="flex flex-col gap-3">
                        <div className="relative">
                          <input
                            ...
                            required
                            className="w-full border border-gray-200 bg-white rounded-[4px] px-5 py-4 text-sm focus:outline-none focus:ring-1 focus:ring-sortd-black pr-12 font-medium text-sortd-black"
                          />
                          <Gift className="w-5 h-5 text-gray-400 absolute right-4 top-1/2 -translate-y-1/2" />
                        </div>
                        <button
                          type="submit"
                          className="w-full bg-sortd-yellow hover:bg-sortd-yellow-hover text-sortd-black font-body font-extrabold text-xs uppercase tracking-wider py-4 rounded-[4px] transition-colors shadow-sm"
                        >
                          Subscribe
                        </button>
                      </form>
