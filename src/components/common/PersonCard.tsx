...
export default function PersonCard({ person, className = "" }: PersonCardProps) {
  return (
    ...
    >
      ...
      {/* Bottom Left Content */}
      <div className="z-10 max-w-[70%] mt-auto select-none">
        <span className="block font-body font-bold text-[9px] text-sortd-black/60 lg:font-heading lg:font-normal lg:text-[28.49px] lg:leading-[31.49px] lg:tracking-[0.72px] uppercase tracking-[0.1em] lg:text-[#0A0A0A] mb-1">
          SORTD PEOPLE
        </span>
        <h3 className="font-heading font-normal text-3xl sm:text-[34px] leading-[0.95] text-sortd-black uppercase tracking-[0.01em] lg:text-[43.09px] lg:leading-[43.09px] lg:tracking-[0.98px] lg:text-[#0A0A0A]">
          {person.name}
        </h3>
      </div>
    </motion.div>
