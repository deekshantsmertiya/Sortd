  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="relative w-full h-[350px] sm:h-[390px] rounded-[10px] overflow-hidden bg-sortd-black shadow-sortd-sm group-hover:shadow-sortd-hover transition-all"
      >
        <Image
        ...
        <div className="absolute top-3 left-3 z-10">
          <span
            className={`h-[22px] px-2.5 rounded-[4px] font-body font-bold text-[9px] uppercase tracking-wider inline-flex items-center justify-center select-none ${badgeStyle.textColorClass}`}
        ...
        {/* Duration Badge */}
        <div className="absolute bottom-3 right-3 z-10 text-[10px] font-bold text-white bg-black/60 px-2 py-0.5 rounded-[4px]">
          {video.duration}
        </div>
      ...
      <p className="mt-2 text-xs font-semibold text-sortd-black line-clamp-1 px-1">
        {video.description}
      </p>
    </div>
  );
