...
export default function Footer() {
  return (
    <footer className="bg-[#0A0A0A] text-white pt-12 pb-8 border-t border-white/5 select-none">
      <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
        ...
        <div className="hidden md:flex flex-col items-center text-center gap-6">
          {/* Logo Mark */}
          <div className="relative w-[79.5px] h-[111px]">
            <Image
              src="/Footer.png"
              alt="Sortd Logo"
              fill
        ...
        <div className="flex md:hidden flex-col gap-10">
          <div className="flex justify-between items-start w-full gap-8">
            ...
            <div className="flex flex-col gap-6">
              <div>
                <h3 className="text-[10px] sm:text-[11px] font-extrabold uppercase tracking-widest text-[#555555] mb-3">
                  SECTIONS
                </h3>
          ...
          <div className="w-full text-center pt-8 border-t border-white/5 text-[11px] text-[#555555] font-medium">
            © 2026 Sortd Dubai. All rights reserved.
          </div>
        </div>
