          ...
          <div className="flex flex-col lg:flex-row gap-8 items-start">
            ...
            <div className="flex-1 min-w-0 flex flex-col">
              ...
              <div className="flex flex-wrap items-center gap-3 pb-6 border-b border-gray-200 mb-8">
                ...
                <button
                  onClick={handleShare}
                  className="inline-flex items-center gap-2 px-4 py-2 rounded-none border border-gray-200 hover:border-sortd-black bg-white text-gray-400 hover:text-black font-body font-medium text-xs transition-all"
                >
