          ...
          <div className="flex flex-wrap gap-2 sm:gap-3">
            {categoriesList.map((cat) => (
              <button
                ...
                className={`px-4 py-2 rounded-[8px] font-body font-bold text-xs tracking-wider uppercase transition-all border-2 ${
...
export default function NewsPage() {
  return (
    <Suspense fallback={
      <div className="min-h-screen bg-[#F7F9FC] flex flex-col justify-between selection:bg-sortd-yellow selection:text-sortd-black">
        <Header />
        <main className="flex-grow py-12 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full flex items-center justify-center">
