...
export default function RootLayout({
  ...
  return (
    <html lang="en" className={`${bebasNeueFont.variable} ${dmSansFont.variable} overflow-x-hidden w-full max-w-full`}>
      <body className="font-body text-sortd-black bg-[#F7F7F8] antialiased selection:bg-sortd-yellow selection:text-sortd-black overflow-x-hidden w-full max-w-full">
